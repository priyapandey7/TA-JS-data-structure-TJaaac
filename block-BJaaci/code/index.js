...
movies[0].genres[movies[1].genres.length - 2];
// 18. Log all the genres of the first movie one by one
for (let genres of movies[0].genres) {
  console.log(genres);
}
// 19. Log all the genres of the second movie one by one
// console.log(movies[1].genres[(0, 1, 2)]);
...
for (let actor of movies[0].actors) {
  if (actor === "Rachel McAdams") {
    console.log(true);
  } else {
    console.log(false);
  }
